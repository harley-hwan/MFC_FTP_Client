...
BOOL CFTP_User_infoDlg::OnInitDialog()
{
	...
	/**************Test용 나중에 삭제***************/
	m_ctrl_Server_IP.SetAddress(192, 168, 8, 1);
	SetDlgItemText(IDC_USER_ID, _T("dbgftp"));
	SetDlgItemText(IDC_USER_PW, _T("gradar"));
